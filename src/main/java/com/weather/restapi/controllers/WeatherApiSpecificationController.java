...
@RestController
public class WeatherApiSpecificationController {

	public static final String SWAGGER_JSON = "weather-api-specification.json";
	...
	public void getSwaggerSpec(HttpServletResponse response) throws Exception {
		try (InputStream resourceAsStream = this.getClass().getClassLoader().getResourceAsStream(SWAGGER_JSON)) {
